...
{
    // TODO: FeatureSummary
    public override Task<GetPorterInformationResponse> GetPorterInformation(GetPorterInformationRequest request,
        ServerCallContext context)
    {
        var featureSummary = new FeatureSummary();
        featureSummary.AppInfoSources.AddRange(_globalContext.InstanceContext.SupportedAppInfoSources.Select(s =>
            new FeatureFlag
            {
                Id = s,
                Name = string.Empty,
