...
public partial class AngelaService : Librarian.Sephirah.Angela.AngelaService.AngelaServiceBase
{
    ...
    public AngelaService(ILogger<AngelaService> logger, ApplicationDbContext dbContext, LibrarianSephirahService.LibrarianSephirahServiceClient sephirahClient)
    {
        _logger = logger;
