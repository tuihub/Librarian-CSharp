...
{
    [Authorize]
    public override Task<DeleteUserSessionResponse> DeleteUserSession(DeleteUserSessionRequest request,
        ServerCallContext context)
    {
        ...
        if (session == null) throw new RpcException(new Status(StatusCode.InvalidArgument, "Session not found"));
