...
namespace Librarian.Sephirah.Services
{
    ...
    {
        [Authorize]
        public override Task<DeleteAppRunTimeResponse> DeleteAppRunTime(DeleteAppRunTimeRequest request, ServerCallContext context)
        {
            ...
            if (appRunTime == null)
            {
                throw new RpcException(new Status(StatusCode.NotFound, "AppRunTime not found."));
            }
