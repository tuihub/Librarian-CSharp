...
namespace Librarian.Sephirah.Services
{
    public partial class SephirahService : LibrarianSephirahService.LibrarianSephirahServiceBase
    {
        ...
        public override Task<UpdateAppCategoryResponse> UpdateAppCategory(UpdateAppCategoryRequest request, ServerCallContext context)
        {
            ...
            appIdsToAdd.ToList().ForEach(x => appCategory.Apps.Add(new Common.Models.App { Id = x }));
            appIdsToRemove.ToList().ForEach(x => appCategory.Apps.Remove(new Common.Models.App { Id = x }));
            ...
            appInfoIdsToAdd.ToList().ForEach(x => appCategory.AppInfos.Add(new Common.Models.AppInfo { Id = x }));
            appInfoIdsToRemove.ToList().ForEach(x => appCategory.AppInfos.Remove(new Common.Models.AppInfo { Id = x }));
