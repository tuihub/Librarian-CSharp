...
public partial class SephirahService : LibrarianSephirahService.LibrarianSephirahServiceBase
{
    ...
    [Authorize]
    public override Task<UploadAppSaveFileResponse> UploadAppSaveFile(UploadAppSaveFileRequest request,
        ServerCallContext context)
    {
        ...
        var fileMetadata = new FileMetadata(fileMetadataId, request.FileMetadata);
