...
public partial class SephirahService
{
    ...
    /// </summary>
    [Authorize]
    public override async Task<GetStoreAppSummaryResponse> GetStoreAppSummary(GetStoreAppSummaryRequest request,
        ServerCallContext context)
    {
        ...
        // Add app sources
        foreach (var source in storeApp.AppSources) storeAppPb.BoundAppSource.Add(source.Key.ToString(), source.Value);
            ...
            foreach (var saveFile in saveFiles)
            {
                ...
                if (saveFile.FileMetadata != null)
                    saveFilePb.File = new FileMetadata
                    {
                        ...
                        Sha256 = ByteString.CopyFrom(saveFile.FileMetadata.Sha256),
