...
namespace Librarian.Sephirah.Services
{
    ...
    {
        [Authorize]
        public override async Task<DownloadStoreAppBinaryResponse> DownloadStoreAppBinary(DownloadStoreAppBinaryRequest request, ServerCallContext context)
        {
            ...
            var sentinelAppBinary = await _dbContext.Set<Common.Models.Db.SentinelAppBinary>()
            ...
            if (sentinelAppBinary.NeedToken)
            {
                try
                {
                    ...
                    httpClient.DefaultRequestHeaders.Authorization = 
                        new System.Net.Http.Headers.AuthenticationHeaderValue("Bearer", librarianToken);
                    ...
                    {
                        _logger.LogError("Failed to get download token from sentinel. Status: {StatusCode}, Response: {Response}", 
            ...
            {
                downloadResponse.Token = downloadToken;
            }
