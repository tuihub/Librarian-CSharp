...
namespace Librarian.Sephirah.Services
{
    public partial class SephirahService
    {
        ...
        /// </summary>
        [Authorize]
        public override async Task<AcquireStoreAppResponse> AcquireStoreApp(AcquireStoreAppRequest request, ServerCallContext context)
        {
            ...
            var app = new Common.Models.Db.App
            {
                Id = appId,
                UserId = userId,
                Name = storeApp.Name,
