...
{
    public static void ConfigureThirdPartyServices(WebApplicationBuilder builder, GlobalContext globalContext,
        ILogger? logger = null)
    {
        ...
        if (porterConfig.IsVndbEnabled)
        {
            builder.Services.AddSingleton(p =>
                new VndbTcpApiService(p.GetRequiredService<ILogger<VndbTcpApiService>>()));
