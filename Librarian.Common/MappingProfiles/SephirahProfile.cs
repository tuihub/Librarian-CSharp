...
public class SephirahProfile : Profile
{
    public SephirahProfile()
    {
        ...
        CreateMap<Enums.FileType, TuiHub.Protos.Librarian.V1.FileType>()
            .ConvertUsingEnumMapping(opt => opt.MapByName());
        ...
        CreateMap<Models.Db.Session, UserSession>()
            ...
            .ForMember(dest => dest.CreateTime, opt => opt.MapFrom(src => Timestamp.FromDateTime(src.CreatedAt.ToUniversalTime())))
            .ForMember(dest => dest.ExpireTime, opt => opt.MapFrom(src => Timestamp.FromDateTime(src.ExpiredAt.ToUniversalTime())));

        // Account: DB -> Protobuf
        CreateMap<Models.Db.Account, TuiHub.Protos.Librarian.Sephirah.V1.Account>()
            .ForMember(dest => dest.Id, opt => opt.MapFrom(src => new InternalID { Id = src.Id }))
        ...
        CreateMap<Models.Db.AppRunTime, TuiHub.Protos.Librarian.Sephirah.V1.AppRunTime>()
            .ForMember(dest => dest.Id, opt => opt.MapFrom(src => new InternalID { Id = src.Id }))
            ...
            .ForMember(dest => dest.RunTime, opt => opt.MapFrom(src => new TuiHub.Protos.Librarian.V1.TimeRange
            {
        ...
        CreateMap<Models.Db.FileMetadata, TuiHub.Protos.Librarian.V1.FileMetadata>()
            .ForMember(dest => dest.Id, opt => opt.MapFrom(src => new InternalID { Id = src.Id }))
            .ForMember(dest => dest.Name, opt => opt.MapFrom(src => src.Name ?? string.Empty))
