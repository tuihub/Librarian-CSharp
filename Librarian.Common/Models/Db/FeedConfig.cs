...
public class FeedConfig
{
    ...
    public Enums.FeedConfigStatus Status { get; set; }
    public TimeSpan PullInterval { get; set; }
    public bool HideItems { get; set; }
    public DateTime? LastPullTime { get; set; }
    public Enums.FeedConfigPullStatus? LastPullStatus { get; set; }

    [MaxLength(65535)] public string? LastPullMessage { get; set; }
    ...
    // computed
    [NotMapped] public string Category { get; set; } = null!;
