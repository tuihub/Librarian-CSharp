...
public class Device
{
    ...
    public Device(long internalId, TuiHub.Protos.Librarian.Sephirah.V1.Device device)
    {
        ...
        SystemType = device.SystemType.ToEnumByString<Enums.SystemType>();
    ...
    [MaxLength(255)] public string DeviceName { get; set; } = null!;

    public Enums.SystemType SystemType { get; set; }

    [MaxLength(255)] public string SystemVersion { get; set; } = string.Empty;

    [MaxLength(255)] public string ClientName { get; set; } = string.Empty;

    [MaxLength(4095)] public string ClientSourceCodeAddress { get; set; } = string.Empty;

    [MaxLength(255)] public string ClientVersion { get; set; } = string.Empty;
