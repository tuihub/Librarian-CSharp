...
namespace Librarian.Common.Migrations
{
    ...
    [Migration("20240118024743_ProtoV0_3_7")]
    partial class ProtoV0_3_7
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Librarian.Common.Models.AppPackageBinaryChunk", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");

                    b.Property<long>("AppPackageBinaryId")
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("AppPackageBinaryId");

                    b.ToTable("AppPackagesBinariesChunks");
                });
            ...
            modelBuilder.Entity("Librarian.Common.Models.AppPackageBinaryChunk", b =>
                {
                    b.HasOne("Librarian.Common.Models.AppPackageBinary", "AppPackageBinary")
                        .WithMany("AppPackageBinaryChunks")
                        .HasForeignKey("AppPackageBinaryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Librarian.Common.Models.AppPackageBinary", b =>
                {
                    b.Navigation("AppPackageBinaryChunks");
                });
